...
async function load(){
  try{
    ...
    content.innerHTML=`<div class="error"><strong>Document unavailable.</strong><p>${esc(error.message)}</p><p>BCP.md remains the sole authoritative BCP in the repository.</p></div>`;
  }
}
load();
